...
export const WorkFlow = () => {
  // Animation variants for alternating motion
  const variants = {
    hidden: (direction) => ({
      opacity: 0,
  ...
  return (
    <div className="relative w-screen min-h-screen p-2 md:p-8">
      ...
      {/* Step 1 */}
      <motion.div
        className="relative z-20 max-w-6xl min-h-64 rounded-lg mx-auto bg-gradient-to-r from-[#3770CD]/20 from-[10%] to-[#9DCBE8]/20 to-[40%] flex flex-col md:flex-row mt-10 justify-around items-center gap-8 p-4"
        initial="hidden"
        whileInView="visible"
      ...
      {/* Step 2 */}
      <motion.div
        className="relative z-20 max-w-6xl min-h-64 rounded-lg mx-auto bg-gradient-to-r from-[#3770CD]/20 from-[10%] to-[#9DCBE8]/20 to-[40%] flex flex-col md:flex-row-reverse mt-10 justify-around items-center gap-8 p-4"
        initial="hidden"
        whileInView="visible"
        viewport={{ once: true, amount: 0.5 }}
        custom="left"
