...
export const HeroSection = () => {
  ...
  // Framer Motion Variants for Stats Animation
  const statsVariants = {
    ...
    visible: (custom) => ({
      ...
      transition: {
        duration: 0.6,
        delay: custom * 0.2, // Delay each item by 0.2s
        ease: "easeOut",
      },
    }),
  };
  ...
  return (
    <div className="relative w-screen min-h-screen flex flex-col justify-center items-center p-2 md:p-8">
      ...
      <div className="w-full flex flex-col z-10 justify-center items-center mt-36 md:mt-20 ">
        ...
        <div className="w-full flex flex-wrap max-md:gap-4 justify-center md:justify-evenly items-center mt-8 ">
          <motion.div
            className="bg-[#C5DBED] w-52 h-28 rounded-xl md:mt-14 flex flex-col justify-center items-center shadow-lg"
          ...
          <motion.div
            className="bg-[#C5DBED] w-52 h-28 rounded-xl flex flex-col justify-center items-center shadow-lg"
            variants={statsVariants}
            initial="hidden"
            whileInView="visible"
            custom={2}
