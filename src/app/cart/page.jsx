...
function CartPage() {
  ...
  const handleAddToCart = (item) => {
    ...
    setCart([
      ...cart,
      { ...item, quantity: item.category === 'product' ? 1 : undefined },
    ]);
  };
  ...
  return (
    <div className="pt-24 md:pt-32 mx-auto w-screen min-h-screen flex flex-col i md:flex-row p-4 md:p-8 gap-5">
          ...
          {cart.map((item) => (
            ...
            >
              ...
              <div
                ...
                className='max-md:w-full flex items-center md:justify-center justify-between gap-2'
              >
