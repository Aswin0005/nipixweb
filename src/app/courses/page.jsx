...
const content =[
    ...
    { sno:'1', title: "Introduction to web development", duration: "3:30 mins" },
      ...
      <div className="min-h-screen">
        <div className="bg-gradient-to-r from-[rgb(14,84,127)] to-[rgb(71,175,239)] h-[540px]">
            ...
            <div className="flex flex-col md:flex-row text-white">
              <div className="flex flex-col md:pr-32 md:basis-3/5 mb-6 md:mb-0">
                ...
                <p className="font-light pb-3 text-sm">
                  by John Doe, <span className="font-semibold">Senior Software Engineer</span>
                </p>
                <p className="font-normal text-sm md:text-base pr-4 md:pr-10">
                  Learn to build powerful, scalable, and responsive web applications using React, the most popular JavaScript library for building user interfaces.
                </p>
              ...
              <div className="md:basis-2/5 relative flex justify-center">
                ...
                <button className="bg-white bg-opacity-70 rounded-full w-[55px] h-[55px] pl-1 absolute inset-0 left-[45%] top-[40%]">
                  <Image src="/playbutton.png" width={20} height={20} alt="playbutton" className="ml-[15px]" />
                </button>
              </div>
            </div>
            ...
            <div className="flex justify-center items-center mt-12 px-4">
              <div className="bg-white rounded-full w-2/3 drop-shadow-xl py-4 md:py-0 md:h-[90px] flex flex-col md:flex-row justify-center items-center md:items-stretch md:space-x-4 lg:space-x-16">
                <div className="flex items-center mb-4 md:mb-0">
                  ...
                  <p className="font-semibold text-sm md:text-base">Beginner Level</p>
                </div>
                <div className="flex items-center mb-4 md:mb-0">
                ...
                <div className="flex flex-col items-center md:items-start mb-4 md:mb-0">
                  <div className="flex items-center pt-6">
                    <p className="font-semibold pr-2 text-sm md:text-base">4.7</p>
                    <div className="flex">
                      {[...Array(5)].map((_, i) => (
                        <Image key={i} src="/starimage.png" width={20} height={20} alt="star" />
                      ))}
                    </div>
                  </div>
                  <p className="font-extralight text-xs md:text-sm">5000+ ratings</p>
                </div>
                <div className="flex flex-col items-center pt-6 pb-3 ">
                  ...
                  <p className="text-xs md:text-sm font-light  md:mt-2">+200 students</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-6xl mx-auto px-4 py-8">
            <div className="mb-8">
              <div className="p-6">
                <div className="flex justify-center items-center">
                  <h2 className="text-2xl md:text-4xl font-bold mb-6">What you'll Learn</h2>
                </div>
            ...
            <div className="p-6">
              <div className="flex justify-center items-center">
                <h2 className="text-2xl md:text-4xl font-bold mb-4">Course content</h2>
              </div>
              <div className="drop-shadow-md bg-white px-6 py-6">
                {content.map((item, index) => (
                  <div key={index} className="flex items-center text-gray-500 rounded-lg shadow-md justify-between py-2 border-b last:border-b-0 hover:bg-black hover:rounded-lg px-3 hover:text-white  ">
                    <div className="flex items-center">
                      <CirclePlay />
                      <span className="pl-2 text-sm md:text-lg " >{item.sno}.</span>
                      <span className="pl-2 text-sm md:text-lg  ">{item.title}</span>
                    </div>
                    <span className="text-xs md:text-base">{item.duration}</span>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="mt-8 flex flex-col justify-center items-center">
              <div className="flex justify-center items-center">
                <h2 className="text-2xl md:text-4xl font-bold mb-4">About the instructor</h2>
              </div>
              <div className="p-6 bg-white rounded-lg shadow-lg w-full md:w-3/4">
                <div className="flex flex-col md:flex-row items-start">
                  <Image src="/instructorprofile.jpg" alt="John Doe" width={80} height={80} className="rounded-lg mr-4 mb-4 md:mb-0" />
                  <div>
                    <h3 className="text-lg md:text-xl font-bold">John Doe</h3>
                    <p className="text-gray-600 mb-2 font-semibold">Senior Software Engineer</p>
                    <p className="text-xs md:text-sm text-gray-500">
                      John is a seasoned software engineer with over 10 years of experience in building web applications. He's passionate about React and has been using it since its early days. John has worked on numerous large-scale projects and loves sharing his knowledge with others.
                    </p>
                  </div>
                </div>
              </div>
